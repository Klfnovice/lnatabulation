        ...
        if st.session_state.page is not None:
            ...
            if uploaded_file is not None:
                ...
                if df is not None:
                    ...
                    conn = sqlite3.connect("competencies.db")
                    df.to_sql(st.session_state.page, conn, if_exists="replace", index_col=0)  # Add index=False here
                    conn.close()
